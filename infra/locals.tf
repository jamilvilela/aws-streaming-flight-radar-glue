...
locals {
  ...
  origins_s3_path   = var.glue_origins_s3_path != "" ? var.glue_origins_s3_path : "s3://${local.buckets.workspace}/config/origins.json"
  target_s3_path    = var.glue_target_s3_path != "" ? var.glue_target_s3_path : "s3://${local.buckets.workspace}/config/target.json"
